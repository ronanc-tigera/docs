...
<FelixConfig configType='yaml' name="Process: Feature detection/overrides" />
...
<FelixConfig configType='yaml' name="Process: Go runtime" />

#### Process: Health port and timeouts

<FelixConfig configType='yaml' name="Process: Health port and timeouts" />

#### Process: Logging

<FelixConfig configType='yaml' name="Process: Logging" />

#### Process: Prometheus metrics

<FelixConfig configType='yaml' name="Process: Prometheus metrics" />

#### Dataplane: Common

<FelixConfig configType='yaml' name="Dataplane: Common" />

#### Dataplane: iptables

<FelixConfig configType='yaml' name="Dataplane: iptables" />

#### Dataplane: nftables

<FelixConfig configType='yaml' name="Dataplane: nftables" />

#### Dataplane: eBPF

<FelixConfig configType='yaml' name="Dataplane: eBPF" />

#### Dataplane: Windows

<FelixConfig configType='yaml' name="Dataplane: Windows" />

#### Dataplane: OpenStack support

<FelixConfig configType='yaml' name="Dataplane: OpenStack support" />

#### Dataplane: XDP acceleration for iptables dataplane

<FelixConfig configType='yaml' name="Dataplane: XDP acceleration for iptables dataplane" />

#### Overlay: VXLAN overlay

<FelixConfig configType='yaml' name="Overlay: VXLAN overlay" />

#### Overlay: IP-in-IP

<FelixConfig configType='yaml' name="Overlay: IP-in-IP" />

#### Overlay: Wireguard

<FelixConfig configType='yaml' name="Overlay: Wireguard" />

#### AWS integration

<FelixConfig configType='yaml' name="AWS integration" />

#### Debug/test-only (generally unsupported)

<FelixConfig configType='yaml' name="Debug/test-only (generally unsupported)" />

#### Usage reporting

<FelixConfig configType='yaml' name="Usage reporting" />
