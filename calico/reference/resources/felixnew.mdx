...
# Felix configuration NEW FOR TESTING
...
<FelixConfig name="Process: Go runtime" />

#### Process: Health port and timeouts

<FelixConfig name="Process: Health port and timeouts" />

#### Process: Logging

<FelixConfig name="Process: Logging" />

#### Process: Prometheus metrics

<FelixConfig name="Process: Prometheus metrics" />

#### Dataplane: Common

<FelixConfig name="Dataplane: Common" />

#### Dataplane: iptables

<FelixConfig name="Dataplane: iptables" />

#### Dataplane: nftables

<FelixConfig name="Dataplane: nftables" />

#### Dataplane: eBPF

<FelixConfig name="Dataplane: eBPF" />

#### Dataplane: Windows

<FelixConfig name="Dataplane: Windows" />

#### Dataplane: OpenStack support

<FelixConfig name="Dataplane: OpenStack support" />

#### Dataplane: XDP acceleration for iptables dataplane

<FelixConfig name="Dataplane: XDP acceleration for iptables dataplane" />

#### Overlay: VXLAN overlay

<FelixConfig name="Overlay: VXLAN overlay" />

#### Overlay: IP-in-IP

<FelixConfig name="Overlay: IP-in-IP" />

#### Overlay: Wireguard

<FelixConfig name="Overlay: Wireguard" />

#### AWS integration

<FelixConfig name="AWS integration" />

#### Debug/test-only (generally unsupported)

<FelixConfig name="Debug/test-only (generally unsupported)" />

#### Usage reporting

<FelixConfig name="Usage reporting" />
